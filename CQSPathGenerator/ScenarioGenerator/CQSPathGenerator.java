...
public class CQSPathGenerator extends PathGenerator {
	...
	public static void main(String[] args){
		...
		cqs.loadActivityGraph("src\\bank.txt");
		//cqs.loadActivityGraph("src\\bankSequence1.txt");
		//cqs.loadActivityGraph("src\\desktopStartup.txt");
		//cqs.loadActivityGraph("src\\mapRendering.txt");
		//cqs.loadActivityGraph("src\\DiningPhilosopher.txt");
